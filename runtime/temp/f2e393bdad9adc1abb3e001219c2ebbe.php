<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\wamp64\www\www.d.com\public/../application/index\view\shop\shop_detail.html";i:1509182735;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
       ...
       <script>
            $(function(){
                $('#cart-pay').click(function(event){
                    ...
                    var item = $.cookie('cart'+<?php echo $res['shop_id']; ?>);//订单json数据格式信息
                    ...
                    // var itemId=parents(".menu-item").attr("item-id");
                    // var a = $('.shop-item .item-name')[2].innerText; 
                    // console.log(a);
                    //总价
                    ...
                    <!-- <label class="checkbox view-check fr" title="有内容的评论" model="filterObj">
                        ...
                        <article class="review-item">
                                <div class="fr review-search order-detail">
                                    <a class="review-read-color review-order">爆炒鱿鱼</a> |
                                    <a class="review-read-color review-order">爆炒鱿鱼</a> |
                                    <a class="review-read-color review-order">爆炒鱿鱼</a>
                                </div>
                                <span>183****7031</span>
...
<!---------------------内容部分------------------------>
        <div class="shop-content"> 
            ...
            <div class="gonggao-wrap">
             <div class="gonggao">     
                <b> 平均送达时间：<strong><?php echo $res['shop_get_time']; ?>分钟</strong></b> &ensp;|&ensp;
				...
				<!-- 评论区 -->
				<b><a href="" style="color: red;font-size: 18px;text-decoration: underline" id="commit">评论区</a></b>
